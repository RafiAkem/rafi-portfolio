...
import { education, experience, organization, profile } from "@/lib/content";
import { Reveal } from "@/components/reveal";

const CREDENTIALS = [education, organization] as const;
    ...
    >
      <Reveal>
        <div className="flex flex-wrap items-end justify-between gap-6 border-b border-border pb-6">
          <h2 className="display text-[clamp(1.625rem,3.4vw,2.75rem)]">Pengalaman</h2>
          <a
            href={profile.cvUrl}
